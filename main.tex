...
% + Chi è GlobalPlatform
% + Non tutti lo rispettano, ma si sta diffondendo
% + Architettura di un TEE conforme GlobalPlatform
% + Interfaccia unificata per permettere il porting delle TA su TEE diversi
% + Spulcia i documenti GlobalPlatform per idee
