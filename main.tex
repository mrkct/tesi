...
Per esempio, in \cite{tee-blockchain} viene proposto di utilizzare i TEE per
...
Un'altra proposta, sempre in questo mondo, è quella di \cite{tee-smartcontract}
che cerca di migliorare l'efficienza nell'esecuzione degli smart contract.
