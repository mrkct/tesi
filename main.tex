...
oltre ad un set di argomenti, può accettare anche degli argomenti extra
...
\texttt{ioctl} che si possono vedere nell'interfaccia userspace,
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \texttt{alloc}: Chiamata quando il sottosistema TEE ha
            ...
            con i dati necessari per accedere alla memoria condivisa e
...
e renderlo disponibile alle applicazioni userspace.
